...
public interface ServiceInf {
	...
	public String nciicStat(String inLicense, String inConditions)
			throws Exception;
	...
	public String nciicCheckChina(String inLicense, String inConditions)
			throws Exception;
	...
	public String tmtx(java.lang.String licensecode, java.lang.String condition)
			throws Exception;

	public String nciicCheckMobile(String inLicense, String inConditions)
			throws Exception;

	public String wmrzCheck(String inLicense, String inConditions)
			throws Exception;
	...
	public String nciicCheckScan(String inLicense, String inConditions,
	...
	public String faceProxy(int compressFlag, String galleryBase64Image,
			int galleryMaxHeight, int galleryMaxSize, String probeBase64Image,
			int probeImgType, int probeMaxHeight, int probeMaxSize)
			throws Exception;
