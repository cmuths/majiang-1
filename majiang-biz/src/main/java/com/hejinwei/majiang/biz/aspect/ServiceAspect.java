package com.hejinwei.majiang.biz.aspect;
...
public class ServiceAspect {  
    ...
    @Around("execution(* com.hejinwei.majiang.biz.impl.service..*.*(..))")  
    public Object process(ProceedingJoinPoint jp) throws java.lang.Throwable {
    	Object rvt = null;
			...
			//logger.info("【Service】调用方法：{}，入参：{}", methodInfo, paramInfo);
			logger.info("{\"Service_method_start\":{},\"params\":{}}", methodInfo, paramInfo);
			rvt = jp.proceed();
			long endTime = System.currentTimeMillis();
			String returnInfo = JSON.toJSONString(rvt);
			long time = endTime - startTime;
//			logger.info("调用方法：{}，返回值：{}，耗时：{}ms", methodInfo, returnInfo, time);
			logger.info("{\"Service_method_end\":{},\"returnData\":{},\"duration\":{}}", methodInfo, returnInfo, time);
			return rvt;
    }
} 